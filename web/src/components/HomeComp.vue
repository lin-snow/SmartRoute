<template>
  <div class="w-2/5 mx-auto relative top-64">
    <div>
      <h1 class="my-2 font-mono">Welcome to <a href="/about" class="no-underline text-sky-400 font-bold italic text-xl">SmartRoute!</a> </h1>
...
const queryRoutes = async () => {
  ...
  if (userStore.allRoutes === null || userStore.allRoutes.length === 0 || userStore.loading === true) {
    ElNotification({
      title: '暂无线路',
      message: '暂无线路',
      type: 'warning',
